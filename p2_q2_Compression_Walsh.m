% Compress an image file (256 x 256 x 8 image) using Walsh transforms.
% Display the resulting image after decompression along with the 
% originals, for 8 different compression ratios.
...
size(img1)
img1 = round(walsh256(double(img1)));
...
deco_image1 = round(walsh256(dimg1));
deco_image2 = round(walsh256(dimg2));
deco_image3 = round(walsh256(dimg3));
deco_image4 = round(walsh256(dimg4));
